          ...
          <div class="col-md-8 offset-2 mt-5">
            ...
            <div class="card">
              <div class="card-body login-card-body">
                <p class="login-box-msg">Client Login Form</p>
                  <form action="./Submits/client_login.php" method="post">
                    ...
                    <div class="social-auth-links text-center mb-3">
                      <p>- OR -</p>
                      <a href="login.php" class="btn btn-block btn-default">
                        <i class="fa fa-user mr-2"></i> Sign in As an Admin / Surveyor
                      </a>
