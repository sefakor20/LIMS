...
$owner_details = $fetch_data->getSigleJoinItem('SELECT land_applications.id, land_applications.client_id, land_applications.land_location, land_applications.means_of_acquisition, land_applications.created_at, clients.first_name, clients.surname, clients.other_name, application_status.name AS status, acquisition.name AS acquisition', 'land_applications', 'JOIN clients ON clients.id = land_applications.client_id JOIN application_status ON application_status.id = land_applications.application_status JOIN acquisition ON acquisition.id = land_applications.means_of_acquisition', 'land_applications.id', $_GET['uid']);


$application_status = $fetch_data->getItemsWithNoComparison('SELECT id, name', 'application_status');
        ...
        <div class="card card-default">
              ...
              <div class="card-body">
                <ul class="nav nav-tabs" id="custom-content-below-tab" role="tablist">
                  ...
                  <li class="nav-item">
                    <a class="nav-link" id="custom-content-below-settings-tab" data-toggle="pill" href="#custom-content-below-settings" role="tab" aria-controls="custom-content-below-settings" aria-selected="false">Take Action</a>
                  </li>
                </ul>
                <div class="tab-content" id="custom-content-below-tabContent">
                  ...
                  <div class="row">
                      ...
                      <div class="card-body">
                        <form action="Submits/stage1.php" method="post">
                          <div class="row">
                          <input type="hidden" name="client_id" value="<?php echo $owner_details->client_id; ?>">
                            <div class="col-md-12 ">
                        ...
                        <form action="Submits/stage1.php" method="post">
                          ...
                          <input type="hidden" name="client_id" value="<?php echo $_SESSION['client']; ?>">
                            <div class="col-md-12 ">
                              ...
                              <br>
                              <iframe src="https://www.google.com/maps/embed?pb=!1m16!1m12!1m3!1d3963.255397727395!2d0.4634020639443022!3d6.615158321783368!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!2m1!1sHO%20BANKOE!5e0!3m2!1sen!2sgh!4v1594117678379!5m2!1sen!2sgh" width="100%" height="450" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
                            </div>
                          </div>
                        </form> 
                      </div>
                  ...
                  <div class="tab-pane fade" id="custom-content-below-messages" role="tabpanel" aria-labelledby="custom-content-below-messages-tab">
                    <div class="table-responsive mt-5">
                      <table class="table table-striped">
                        ...
                        <tbody>
                          <?php 
                            $user_docs = $fetch_data->getClientDocs($owner_details->id); 
                          ?>
                  ...
                  <div class="row">
                      ...
                      <div class="card-body">
                        <form action="../Submits/surveyor_approval.php" method="post">
                          <div class="row">
                          <input type="hidden" name="application_id" value="<?php echo $owner_details->id; ?>">
                            <div class="col-md-12 ">
                              <div class="form-group">
                                <label for="surveyor" class="font-weight-normal">Take Final Action</label>
                                  <select name="application_status" id="application_status" class="form-control">
                                    <option value="" class="selected">-- Choose Option --</option>
                                    <?php foreach($application_status as $a): ?>
                                      <?php if(($a->id != 1) && ($a->id != 2) && ($a->id != 3) && ($a->id != 6) && ($a->id != 7) ): ?>
                              ...
                              <div class="form-group">
                                <button type="submit" class="btn btn-default"><i class="fa fa-check"></i> Take Action</button>
                              </div>
                            </div>
                          </div>
                        </form> 
