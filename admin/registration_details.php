 ...
 <?php include 'includes/top-nav.php'; ?>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      <img src="../dist/img/AdminLTELogo.png" alt="LandMIS Logo" class="brand-image img-circle elevation-3"
        ...
        <div class="card card-default">
              ...
              <div class="card-body">
                <ul class="nav nav-tabs" id="custom-content-below-tab" role="tablist">
                  ...
                  <li class="nav-item">
                    <a class="nav-link" id="custom-content-below-settings-tab" data-toggle="pill" href="#custom-content-below-settings" role="tab" aria-controls="custom-content-below-settings" aria-selected="false">Assign a Surveyor</a>
                  </li>
                </ul>
                <div class="tab-content" id="custom-content-below-tabContent">
                  ...
                  <div class="row">
                      ...
                      <div class="card-body">
                        <form action="../Submits/assign_surveyor.php" method="post">
                          <div class="row">
                            <div class="col-md-12 ">
                              <div class="form-group">
                                <input type="hidden" name="application_id" value="<?php echo $owner_details->id; ?>">
                                <label for="surveyor" class="font-weight-normal">Assign Surveyor</label>
                                  <select name="surveyor_id" id="surveyor_id" class="form-control">
                                    <option value="" class="selected">-- Choose Option --</option>
                                    <?php foreach($surveyor as $a): ?>
                                      <?php if($a->user_role != 1): ?>
                                        <option value="<?php echo $a->id; ?>"><?php echo $a->first_name .' '. $a->surname .' '. $a->other_name; ?></option>
                                      <?php endif; ?>
                                    <?php endforeach; ?>
                                  </select>
                              </div>
                              <div class="form-group">
                                <button type="submit" class="btn btn-default"><i class="fa fa-check"></i> Assign</button>
                              </div>
                            </div>
                          </div>
                        </form> 
